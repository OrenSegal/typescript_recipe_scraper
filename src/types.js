...
import { IngredientCategory, CookingAction } from '../recipe-parsing-specification.js';
...
export const RecipeIngredientSchema = z.object({
    ...
    quantity: z.union([z.number(), z.array(z.number().min(0)).length(2)]).nullable(), // Support ranges like [1, 1.5]
    unit: z.string().nullable(),
    name: z.string().min(1, "Clean ingredient name cannot be empty"), // Non-branded product name
    notes: z.string().nullable(), // Preparation notes, quality descriptors
    category: IngredientCategory.nullable(), // Standardized ingredient category
    grams: z.number().min(0).nullable().optional() // For nutrition calculations
