 ...
 */
export function generateRecipeEmbedding(recipe: Recipe): number[] {
 ...
 */
export function findSimilarRecipes(targetEmbedding: number[], recipeEmbeddings: { id: string, embedding: number[] }[], topK: number = 5): { id: string, similarity: number }[] {
