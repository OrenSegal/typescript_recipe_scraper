 ...
 */
export function detectMealTypes(
  title: string,
  description: string,
  ingredients: RecipeIngredient[],
  instructions: InstructionStep[],
  ...
  const detectedMealTypes: string[] = [];
 ...
 */
export function generateMeaningfulTags(
  title: string,
  description: string,
  ingredients: RecipeIngredient[],
  instructions: InstructionStep[],
 ...
 */
export function smartCategorizeRecipe(
  title: string,
  description: string = '',
  ingredients: RecipeIngredient[],
  instructions: InstructionStep[],
  ...
  const tags = generateMeaningfulTags(
    title, 
    description, 
    ingredients, 
    instructions, 
