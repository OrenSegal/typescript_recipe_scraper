 ...
 */
export const COMPREHENSIVE_EQUIPMENT_DATABASE: EquipmentMapping[] = [
  // COOKWARE - POTS & PANS
  {
...
export class EnhancedEquipmentMatcher {
  private equipmentMap: Map<string, EquipmentMapping>;
   ...
   */
  findEquipment(name: string): EquipmentMapping | null {
   ...
   */
  isKitchenEquipment(name: string): boolean {
